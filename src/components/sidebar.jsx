    ...
    <div className="container">
      <aside className="sidebar">
        <nav>
          ...
          <img src="logo_no_bg.png" alt='logo' width="100" height="50" onClick={() => navigate('/')}></img>
          <a className="active">Admin</a>
          <a onClick={() => navigate('/Employee_Profiles')} className="active">Employee Profiles</a>
          ...
          <a onClick={() => navigate('/Logout')} className="active">Logout</a>
